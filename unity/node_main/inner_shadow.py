...
class CompositorNodeInnerShadowSingle(bpy.types.CompositorNodeCustomGroup, Node):
...
class CompositorNodeInnerShadow(bpy.types.CompositorNodeCustomGroup, Node):
