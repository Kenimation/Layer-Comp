...
feature_node_data['CompositorNodeColorReplace'] = ['ColorReplace', 'CompositorNodeColorReplace', 'OVERLAY']
feature_node_data['CompositorNodeColorInnerShadow'] = ['Color InnerShadow', 'CompositorNodeColorInnerShadow', 'ANTIALIASED']
feature_node_data['CompositorNodeColorInnerShadowSingle'] = ['Color InnerShadow(Single)', 'CompositorNodeColorInnerShadowSingle', 'ANTIALIASED']
feature_node_data['CompositorNodeDropShadow'] = ['DropShadow', 'CompositorNodeDropShadow', 'SELECT_SUBTRACT']
feature_node_data['CompositorNodeInnerShadow'] = ['InnerShadow', 'CompositorNodeInnerShadow', 'SELECT_INTERSECT']
feature_node_data['CompositorNodeRimLight'] = ['Rim Light', 'CompositorNodeRimLight', 'LIGHT_AREA']
feature_node_data['CompositorNodeOuterGlow'] = ['Outer Glow', 'CompositorNodeOuterGlow', 'LIGHT_SUN']
...
feature_node_data['CompositorNodeHalation'] = ['Halation', 'CompositorNodeHalation', 'SHADERFX']
