...
class CompositorNodeInnerShadowSingle(bpy.types.CompositorNodeCustomGroup, Node, Key_Node):
	bl_name='CompositorNodeInnerShadowSingle'
	bl_label='Inner Shadow (Single)'
	bl_icon='ANTIALIASED'
...
class CompositorNodeInnerShadow(bpy.types.CompositorNodeCustomGroup, Node, Key_Node):
	bl_name='CompositorNodeInnerShadow'
	bl_label='Inner Shadow'
	bl_icon='ANTIALIASED'
